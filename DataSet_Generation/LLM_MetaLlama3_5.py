...
def generate_text(prompt, pipe, tokenizer, max_length=200):
    messages = [
...
def complete_texts_batch(input_texts, pipe, tokenizer, max_length=200, batch_size=4, max_attempts=5):
    all_completed_texts = []
...
def generate_dataset_5(input_file, output_file, model_name="meta-llama/Llama-3.2-3B-Instruct", batch_size=32, max_rows=None):
    ...
    x_j_samples = complete_texts_batch(x_i_samples, pipe, tokenizer, max_length=200, batch_size=batch_size)
...
def run_llama3_generation_5(input_file, output_file, model_name="meta-llama/Llama-3.2-3B-Instruct", batch_size=32, max_rows=None):
